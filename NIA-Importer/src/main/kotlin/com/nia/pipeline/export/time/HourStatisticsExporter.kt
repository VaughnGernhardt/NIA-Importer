...
class HourStatisticsExporter : JsonExporter() {

    fun export(
        statistics: List<HourStatisticsService.HourStatistic>
    ): ExportSummary {
        ...
        Log.logger.info {
            "Exported ${statistics.size} hour statistics."
        }
